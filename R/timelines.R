#' @title Timelines chart
#'
#' @description Create timelines charts with JavaScript library [timelines-chart](https://github.com/vasturiano/timelines-chart).
#'
#' @param data A [data.frame()] (see details) or a list.
